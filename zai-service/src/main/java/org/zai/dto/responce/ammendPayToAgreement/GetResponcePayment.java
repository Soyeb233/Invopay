...
public class GetResponcePayment {
    ...
    public String toString() {
        ...
        sb.append(GetResponcePayment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetResponcePayment) == false) {
            return false;
        }
        GetResponcePayment rhs = ((GetResponcePayment) other);
